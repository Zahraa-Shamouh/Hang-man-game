...
namespace Util
{
    public class WordBank2
    {
        ...
        public static WordBank2 load()
        {
            ...
            //loaded the wordlist 
            TextAsset asset = Resources.Load("disney characters") as TextAsset; //---------
            ...
            S_instance = new WordBank2(words);
            return S_instance;
        }
