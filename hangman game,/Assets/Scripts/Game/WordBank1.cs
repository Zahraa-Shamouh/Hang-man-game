...
namespace Util
{
    public class WordBank1{
        ...
        public static WordBank1 load(){
            ...
            s_instance = new WordBank1(words);
            return s_instance; 
        }
