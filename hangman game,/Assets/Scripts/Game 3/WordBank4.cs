...
namespace Util
{
    public class WordBank4
    {
        ...
        public static WordBank4 load()
        {
            ...
            //loaded the wordlist 
            TextAsset asset = Resources.Load("countries") as TextAsset; //---------
            ...
            S_instance = new WordBank4(words);
            return S_instance;
        }
